//
//  AditionalInfoComponent.swift
//  WeatherApp
//
//  Created by Pierre Campos Dias on 14/09/23.
//

import UIKit


final class AditionalInfoComponent: UIView {
    ...
    private lazy var descriptionLabel = UILabelComponent(labelText: "", fontSize: 14, fontWeight: .regular, fontColor: .secondary)
    ...
    private func configure() {
        self.imageView.image = UIImage(systemName: self.iconType.rawValue)?.scalePreservingAspectRatio(targetSize: self.iconSize).withTintColor(.secondary)
